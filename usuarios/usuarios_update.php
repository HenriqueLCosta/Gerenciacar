...
while ($row = mysqli_fetch_object($query)) {
  ...
  <path fill-rule="evenodd" d="M14.5 1.5a.5.5 0 0 1 .5.5v4.8a2.5 2.5 0 0 1-2.5 2.5H2.707l3.347 3.346a.5.5 0 0 1-.708.708l-4.2-4.2a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 8.3H12.5A1.5 1.5 0 0 0 14 6.8V2a.5.5 0 0 1 .5-.5z"></path>
				...
				<form style="margin: 15px" method="post" enctype="multipart/form-data" name="formulario" action="../usuarios/valid/validar_usuario_update.php">
					<div class="form-row">
					<div class="form-group col-md-5">
							<label for="inputText3">Usuario</label> <input type="text"
								class="form-control" name='usuario' value='<?php echo $usuario ?>' placeholder="Usuario" required="required">
						</div>
						<div class="form-group col-md-7">
							<label for="inputText3">Nome</label> <input type="text"
								class="form-control" name='nome' value='<?php echo $nome ?>' placeholder="Nome completo">
						</div>
						<div class="form-group col-md-6">
							<label for="inputText3">Senha</label> <input type="password"
								class="form-control" name='senha' placeholder="Mantenha em branco para inalteração">
						</div>
						<div class="form-group col-md-6">
  ...
  <option value="1">Usuario</option>
						...
						<div class="form-group col-md-6">
							<label for="inputText3">Senha do Administrador</label> <input type="password"
								class="form-control" name='senhaauten' placeholder="Senha" required="required">
						</div>
						<div  class="form-group col-md-12">
