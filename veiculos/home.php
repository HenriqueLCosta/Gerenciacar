		...
		<div class="card" style="width: 100%; background-color: #93bef9;">
			<table border="1" id="tabela"
				...
				<thead>
					...
					<tr>
						<th colspan="4" class="h3 text-center">Veiculos <a
							href="veiculos_add.php"> <svg xmlns="http://www.w3.org/2000/svg"
...
$sql = "select * from veiculos order by id_veiculo asc";
...
while ($row = mysqli_fetch_object($query)) {
    ...
    $veiculo = $marca." ".$modelo." ".$versao." ".$ano." ".$cor;
    ...
    ?>
		<tr>
						<td><a href="veiculos_read.php?id_veiculo=<?php echo $id_veiculo?>"><?php echo $renavam?></a></td>
