...
<script>
	...
	$(document).on('click', '.apagar', function(event) {
		var result = confirm("Tem certeza que deseja apagar esse veiculo ?");
		if(result == true){
		var id_veiculo = $(this).attr('id_veiculo');
		window.location.href = ("valid/validar_veiculo_del.php?id_veiculo="+id_veiculo);
	...
	$(document).on('click', '.editar', function(event) {
		var id_veiculo = $(this).attr('id_veiculo');
		window.location.href = ("veiculos_update.php?id_veiculo="+id_veiculo);
	     if (window.focus) {newwindow.focus()}
		return false;
		event.preventDefault();
	});
					...
					<div class="form-row">
						<div class="form-group col-md-4">
							<label for="inputText3">Marca</label> <input type="text"
								class="form-control" name='marca' value='<?php echo $marca?>' placeholder="Marca" required="required" <?php echo $disabled?>>
						</div>
						<div class="form-group col-md-4">
							<label for="inputText3">Modelo</label> <input type="text"
								class="form-control" name='modelo' value='<?php echo $modelo?>' placeholder="Modelo" required="required" <?php echo $disabled?>>
						</div>
						<div class="form-group col-md-4">
							<label for="inputText3">Versão</label> <input type="text"
								class="form-control" name='versao' value='<?php echo $versao?>' placeholder="Versão" required="required" <?php echo $disabled?>>
						</div>
						<div class="form-group col-md-2">
							<label for="inputText3">Ano</label> <input type="text"
								class="form-control" name='ano' value='<?php echo $ano?>' placeholder="Ano" required="required" <?php echo $disabled?>>
						</div>
						<div class="form-group col-md-2">
							<label for="inputText3">Cor</label> <input type="text"
								class="form-control" name='cor' value='<?php echo $cor?>' placeholder="Cor" required="required" <?php echo $disabled?>>
						</div>
						<div class="form-group col-md-4">
							<label for="inputText3">Renavam</label> <input type="text"
								class="form-control" name='renavam' value='<?php echo $renavam?>' placeholder="Renavam" required="required" <?php echo $disabled?>>
						</div>
						<div class="form-group col-md-4">
							<label for="inputText3">Placa</label> <input type="text"
								class="form-control" name='placa' value='<?php echo $placa?>' placeholder="Placa" required="required" <?php echo $disabled?>>
						</div>
						<div class="form-group col-md-4">
							<label for="inputText3">Tipo</label> <input type="text"
								class="form-control" name='tipo' value='<?php echo $tipo?>' placeholder="1 = Moto , 2 = Carro e 3 = Outros" required="required" <?php echo $disabled?>>
						</div>
						<div class="form-group col-md-12">
						<button type="button" id_veiculo="<?php echo $id_veiculo?>" class="btn btn-primary editar">
...
<button type="button" id_veiculo="<?php echo $id_veiculo?>" class="btn btn-outline-danger apagar">
